...
class RegisterPage extends React.Component {
  ...
  handleUsernameChange(event, isClick) {
    if (!isClick) this.setState({ userNameErr: false, userNameErrText: "" });
    ...
    if (!value) {
      ...
      if (value.length < 4) {
        this.setState({
          userNameErr: true,
          userNameErrText: "Username is too short."
        });
      } else if (value.length > 30) {
        this.setState({
          userNameErr: true,
          userNameErrText: "Username is less than 30 characters."
        });
      }
    }
    if (!isClick) this.setState({ username: value });
  }
  handleEmailChange(event, isClick) {
    if (!isClick) this.setState({ emailErr: false, emailErrText: "" });
    ...
    if (!isClick) this.setState({ email: value });
  }
  handleFullNameChange(event, isClick) {
    if (!isClick) this.setState({ fullnameErr: false, fullnameErrText: "" });
    const value = !isClick ? event.target.value : this.state.fullname;
    if (!value) {
      this.setState({
        fullnameErr: true,
        fullnameErrText: "Full name is required."
      });
    } else {
      if (value.length > 100) {
        this.setState({
          fullnameErr: true,
          fullnameErrText: "Full name is less than 100 characters."
        });
      }
    }
    if (!isClick) this.setState({ fullname: value });
  }
  handlePasswordChange(event, isClick) {
    if (!isClick) this.setState({ passwordErr: false, passwordErrText: "" });
    ...
    if (!value) {
      ...
      if (value.length < 6) {
        this.setState({
          passwordErr: true,
          passwordErrText: "Password is too short."
        });
      } else if (value.length > 20) {
        this.setState({
          passwordErr: true,
          passwordErrText: "Password is less than 20 characters."
        });
      }
    }
    if (!isClick) this.setState({ password: value });
  }
  handleAgeChange(event, isClick) {
    if (!isClick) this.setState({ ageErr: false, ageErrText: "" });
    const value = !isClick ? event.target.value : this.state.age;
    if (value.length > 0) {
      if (Number.isNaN(+value)) {
        this.setState({
          ageErr: true,
          ageErrText: "Age should be number format"
        });
      } else {
        if (Number.parseInt(value) < 0) {
          this.setState({
            ageErr: true,
            ageErrText: "Age should be positive number"
          });
        }
      }
    }
    ...
    if (!isClick) this.setState({ age: value });
  }
  handleAddressChange(event, isClick) {
    if (!isClick) this.setState({ addressErr: false, addressErrText: "" });
    ...
    if (!value) {
      ...
      if (value.length > 500) {
        this.setState({
          addressErr: true,
          addressErrText: "Address is less than 500 characters."
        });
      }
    }
    if (!isClick) this.setState({ address: value });
  }
  handlePhoneChange(event, isClick) {
    if (!isClick) this.setState({ phoneErr: false, phoneErrText: "" });
    const value = !isClick ? event.target.value : this.state.phone;
    if (!value) {
      this.setState({
        phoneErr: true,
        phoneErrText: "Phone number is required."
      });
    } else {
      if (!new RegExp(/^[0-9]*$/).test(value)) {
        this.setState({
          phoneErr: true,
          phoneErrText: "Phone number is incorrect!"
        });
      }
      if (value.length > 15) {
        return;
    ...
    if (!isClick) this.setState({ phone: value });
  }
  handleMobilePhoneChange(event, isClick) {
    ...
    if (!value) {
      this.setState({
        mobilePhoneErr: true,
        mobilePhoneErrText: "Mobile Phone Number is required."
      });
    } else {
      if (!new RegExp(/^[0-9]*$/).test(value)) {
        this.setState({
          mobilePhoneErr: true,
          mobilePhoneErrText: "Mobile Phone Number is incorrect!"
        });
      }
      if (value.length > 15) {
        return;
    ...
    if (!isClick) this.setState({ mobile_phone: value });
  }
    ...
    checkRef.once("value", res => {
      ...
      if (isNot) {
        this.setState({
          isLoading: false,
          loaded: true,
          infoText: "Username or Email is already existed!"
        });
        return;
      } else {
        ...
        Promise.all([
          userRef.child(userId).set(userItem),
          authRef.child(userId).set(authItem),
          checkRef.child(l).set(checkItem),
          publicRef.set(publicInfo)
        ])
          .then(res => {
            this.setState({
              isLoading: false,
              loaded: true,
              infoText: "Registration is success!"
            });
            ...
            <Grid item xs={6}>
              <Paper className="paper">
                <div className="register-item-wrapper">
                  ...
                  <div className="register-item">
                    Already have an account ? <a href="/login">Go to here</a>{" "}
                    for login !
                  </div>
                  <div className="register-item">
                    <FormControl
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handleUsernameChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handleEmailChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handlePasswordChange(event, false);
                        }}
                        endAdornment={
                          <InputAdornment position="end">
                            <IconButton
                  ...
                  <div className="register-item">
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handleFullNameChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handleAgeChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    ...
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handleAddressChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    ...
                    >
                      <InputLabel htmlFor="filled-adornment-phone">
                        Phone
                      </InputLabel>
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handlePhoneChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    <FormControl
                      variant="outlined"
                      className="form-field"
                      error={this.state.mobilePhoneErr}
                    >
                      ...
                      <OutlinedInput
                        ...
                        onChange={event => {
                          this.handleMobilePhoneChange(event, false);
                        }}
                  ...
                  <div className="register-item">
                    <Button
                      variant="contained"
                      onClick={event => {
                        this.checkBeforeRegister(event);
                      }}
                      color="secondary"
                    >
                      Register
